...
for(const [name,width,height,overlay,alignment,resolution] of ['128'].flatMap(r=>['B'].flatMap(a=>[[r+'-'+a+'-desktop',1280,900,false,a,r],[r+'-'+a+'-mobile',390,844,false,a,r],[r+'-'+a+'-overlay',1280,900,true,a,r]]))){ 
