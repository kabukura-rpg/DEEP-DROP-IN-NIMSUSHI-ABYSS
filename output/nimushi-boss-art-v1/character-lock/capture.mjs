...
for(const [name,width,height,overlay] of [['desktop',1280,900,false],['mobile',390,844,false],['collision-overlay',1280,900,true]]){
 await cdp('Emulation.setDeviceMetricsOverride',{width,height,deviceScaleFactor:1,mobile:false});
 await cdp('Page.navigate',{url:'http://127.0.0.1:5197/DEEP-DROP-IN-NIMSUSHI-ABYSS/output/nimushi-boss-art-v1/character-lock/preview.html'+(overlay?'?overlay=1':'')});
