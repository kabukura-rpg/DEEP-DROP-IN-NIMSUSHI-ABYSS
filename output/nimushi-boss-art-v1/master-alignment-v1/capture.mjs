...
for(const [name,width,height,overlay,alignment] of ['A','B'].flatMap(a=>[[a+'-desktop',1280,900,false,a],[a+'-mobile',390,844,false,a],[a+'-overlay',1280,900,true,a]])){ 
 await cdp('Emulation.setDeviceMetricsOverride',{width,height,deviceScaleFactor:1,mobile:false});
 await cdp('Page.navigate',{url:'http://127.0.0.1:5197/DEEP-DROP-IN-NIMSUSHI-ABYSS/output/nimushi-boss-art-v1/master-alignment-v1/preview.html'+'?alignment='+alignment+(overlay?'&overlay=1':'')});
