...
describe('falling and ammunition', () => {
  ...
  it('subtracts exactly the weapon recoil when the fall is faster than the kick', () => { const game = emptyGame(); game.player.vy = 930; game.shoot(); expect(game.player.vy).toBe(930 - GUN_MODULES.machine.recoil); });
