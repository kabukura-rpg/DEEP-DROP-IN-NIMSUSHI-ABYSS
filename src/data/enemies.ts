...
export const ENEMY_TYPES: Record<EnemyKind, EnemyType> = {
  ...
  caveBat: { id: 'caveBat', name: 'CAVE BAT', shootable: true, stompable: true, flying: true, threat: 'basic', spawnSlot: 'open', spawnWeight: 0.7, hp: 2, silhouette: 'wing', bodyWidth: 24, swaySpeed: 0, damageCause: 'enemy', contactHint: '向かってくる', leavesCorpse: true, behaviour: 'bat', gems: 12 },
  ...
  watcher: { id: 'watcher', name: 'WATCHER', shootable: true, stompable: false, flying: true, threat: 'armored', spawnSlot: 'open', spawnWeight: 0.2, hp: 4, silhouette: 'watcher', bodyWidth: 26, swaySpeed: 0, damageCause: 'spike', contactHint: '踏めない・撃て', behaviour: 'eye', gems: 20 },
